...
CLIENT_ID = 'Y2xpZW50X2lkMTU0NjU5MDgyOTIzNA=='
CLIENT_KEY = 'Y2xpZW50X2tleTE1NDY1OTA4MjkyMzQ='
CLIENT_SECRET = 'Y2xpZW50X3NlY3JldDE1NDY1OTA4MjkyMzQ='
...
def main():
    ...
    if text.find("온도") >= 0:
        temp_str = getText2VoiceStream("현재온도는 {}도 입니다.".format(temp), file_name)
        play_file(file_name)
    elif text.find("습도") >= 0:
        humi_str = getText2VoiceStream("현재습도는 {}퍼센트 입니다.".format(humi), file_name)
        play_file(file_name) 
